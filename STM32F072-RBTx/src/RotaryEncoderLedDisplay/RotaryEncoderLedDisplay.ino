...
void display_data(void){
  display_data = (float)((float)(encoder0Pos/20))
  if (Sign=="0"){
    displayA.setDisplayToSignedDecNumber(display_data, B0000, false);
  } else if (Sign =="-") {
    displayA.setDisplayToSignedDecNumber(display_data*(-1), B0000, false);
  }
}
