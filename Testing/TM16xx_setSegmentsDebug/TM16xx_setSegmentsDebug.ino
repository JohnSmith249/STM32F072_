...
#include <TM1650.h>
TM1650 module(PB7, PB6);  // SDA=PB7, SCL=PB6
...
//#include <TinyDebugmySerial.h>        // NOTE: TinyDebugSerial is not compatible with ATtinyCcore
#if(OPT_DEBUG_PRINT)
#define DEBUG_BEGIN(x) mySerial.begin(x)
#define DEBUG_PRINT(x) (mySerial.print(x))
#define DEBUG_PRINTLN(x) (mySerial.println(x))
#define DEBUG_PRINTLNHEX(x) (mySerial.println(x, HEX))
